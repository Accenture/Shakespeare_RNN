...
# MODERN_FILE_PATH = 'combined_modern.snt.aligned'
MODERN_FILE_PATH = 'combined_original.snt.aligned'
# ORIGINAL_FILE_PATH = 'combined_original.snt.aligned'
ORIGINAL_FILE_PATH = 'combined_modern.snt.aligned'
...
def prepare_data(data_dir, from_vocab_size, to_vocab_size, tokenizer=None):
    print('Preparing data')
    to_train_path = os.path.join(data_dir, MODERN_FILE_PATH)
    from_train_path = os.path.join(data_dir, ORIGINAL_FILE_PATH)

    # Create size vocabularies
    ...
    create_vocabulary(to_vocab_path, to_train_path, to_vocab_size, tokenizer)
    create_vocabulary(from_vocab_path, from_train_path, from_vocab_size,
                      tokenizer)
    ...
    # to_dev_path = os.path.join(data_dir, 'modern_dev')
    # from_dev_path = os.path.join(data_dir, 'original_dev')
    to_dev_path = os.path.join(data_dir, MODERN_FILE_PATH)
    from_dev_path = os.path.join(data_dir, ORIGINAL_FILE_PATH)

    # Create token ids for development data
    to_dev_ids_path = to_dev_path + ('.ids%d' % to_vocab_size)
    from_dev_ids_path = from_dev_path + ('.ids%d' % from_vocab_size)
