...
tf.app.flags.DEFINE_integer("to_vocab_size", 40000, "Modern vocabulary size.")
...
def train():
    ...
    if FLAGS.from_train_data and FLAGS.to_train_data:
        ...
        print('Preparing Shakespeare data in %s' % FLAGS.data_dir)
...
def decode():
    with tf.Session() as sess:
        ...
        original_vocab, _ = data_utils.initialize_vocabulary(from_vocab_path)
        _, rev_modern_vocab = data_utils.initialize_vocabulary(to_vocab_path)
        ...
        while sentence:
            ...
            token_ids = data_utils.sentence_to_token_ids(
                tf.compat.as_bytes(sentence), original_vocab)
            ...
            # Print out Modern sentence corresponding to outputs.
            print(" ".join([
                tf.compat.as_str(rev_modern_vocab[output])
